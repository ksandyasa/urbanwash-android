...
public class ServicesDeluxeConfirmFragment extends Fragment {
    private AppCompatActivity appCompatActivity;
    private View rootView;

    // This is empty constructor. Do not delete it otherwise it will cause force close
    public ServicesDeluxeConfirmFragment() {

    }

    public ServicesDeluxeConfirmFragment(AppCompatActivity aca) {
