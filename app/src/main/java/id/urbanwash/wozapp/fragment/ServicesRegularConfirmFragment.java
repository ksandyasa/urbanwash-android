...
public class ServicesRegularConfirmFragment extends Fragment {
    private AppCompatActivity appCompatActivity;
    private View rootView;

    // This is empty constructor. Do not delete it otherwise it will cause force close
    public ServicesRegularConfirmFragment() {

    }

    public ServicesRegularConfirmFragment(AppCompatActivity aca) {
