...
public class TabContentMyOrderFragment1 extends Fragment implements MyOrderAdapterCallback {
    ...
    public TabContentMyOrderFragment1() {

    }

    public TabContentMyOrderFragment1(AppCompatActivity aca) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.rv_tab_content_myorder_adapter = new MyOrderAdapter(this.appCompatActivity, 1, this);
