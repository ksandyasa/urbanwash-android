...
public class DialogAlertAddress extends AppCompatDialogFragment {
    private AppCompatActivity appCompatActivity;
    private View rootView;

    public DialogAlertAddress() {

    }

    public DialogAlertAddress(AppCompatActivity aca) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.rootView = inflater.inflate(R.layout.dialog_alert_address, container, false);
