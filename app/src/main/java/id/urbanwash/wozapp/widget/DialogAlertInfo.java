...
public class DialogAlertInfo extends AppCompatDialogFragment {
    private AppCompatActivity appCompatActivity;
    private View rootView;

    public DialogAlertInfo() {

    }

    public DialogAlertInfo(AppCompatActivity aca) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.rootView = inflater.inflate(R.layout.dialog_info, container, false);
