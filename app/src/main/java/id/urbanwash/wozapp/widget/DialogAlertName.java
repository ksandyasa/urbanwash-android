...
public class DialogAlertName extends AppCompatDialogFragment {
    private AppCompatActivity appCompatActivity;
    private View rootView;

    public DialogAlertName() {

    }

    public DialogAlertName(AppCompatActivity aca) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.rootView = inflater.inflate(R.layout.dialog_alert_name, container, false);
