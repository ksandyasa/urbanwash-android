...
public class DialogOrderError extends AppCompatDialogFragment {
    private AppCompatActivity appCompatActivity;
    private View rootView;
    private AppCompatButton btn_content2_order_error;
    private StartOrderActivityCallback startOrderActivityCallback;

    public DialogOrderError() {

    }

    public DialogOrderError(AppCompatActivity aca, StartOrderActivityCallback listener) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.btn_content2_order_error = (AppCompatButton) this.rootView.findViewById(R.id.btn_content2_order_error);

        this.btn_content2_order_error.setOnClickListener(new DismissDialogOrderError());
    ...
    class DismissDialogOrderError implements View.OnClickListener {
