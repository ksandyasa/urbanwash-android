...
public class DialogOrderSuccess extends AppCompatDialogFragment {
    private AppCompatActivity appCompatActivity;
    private View rootView;
    private AppCompatButton btn_content2_order_success;
    private StartOrderActivityCallback startOrderActivityCallback;

    public DialogOrderSuccess() {

    }

    public DialogOrderSuccess(AppCompatActivity aca, StartOrderActivityCallback listener) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.rootView = inflater.inflate(R.layout.dialog_order_success, container, false);

        this.btn_content2_order_success = (AppCompatButton) this.rootView.findViewById(R.id.btn_content2_order_success);

        this.btn_content2_order_success.setOnClickListener(new DismissDialogOrderSuccess());
    ...
    class DismissDialogOrderSuccess implements View.OnClickListener {
